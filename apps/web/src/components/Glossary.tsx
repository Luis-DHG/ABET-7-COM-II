...
const terms = [
  ...
  { term: "OFDM", name: "Orthogonal Frequency Division Multiplexing", definition: "Distribuye símbolos entre subportadoras ortogonales. En condiciones ideales, su separación Δf es el inverso de la duración útil Tu del símbolo.", equation: "Δf = 1 / Tu   [Hz]", example: "1024 subportadoras en 20 MHz dan Δf = 19,53125 kHz." },
  ...
  { term: "Doppler", name: "Desplazamiento de frecuencia", definition: "Cambio de frecuencia asociado con el movimiento relativo. En el modelo monostático del blog depende de la velocidad radial v y de la portadora fc.", equation: "fD = 2 v fc / c   [Hz]", example: "A 5,9 GHz, un objetivo acercándose a 15 m/s produce unos 590,4 Hz." },
  ...
  { term: "BER", name: "Bit Error Rate", definition: "Fracción de bits recibidos incorrectamente respecto al total transmitido. Es adimensional y debe acompañarse del canal, la modulación y la cantidad de bits evaluados.", equation: "BER = bits erróneos / bits transmitidos", example: "10 errores en 100 000 bits dan una BER de 0,0001." },
  { term: "SNR", name: "Signal-to-Noise Ratio", definition: "Relación entre potencia de señal y ruido en un punto y ancho de banda definidos. Su valor en dB es una transformación logarítmica, no una unidad de potencia.", equation: "SNRdB = 10 log₁₀(Ps / Pn)   [dB]", example: "Una señal con diez veces la potencia del ruido tiene SNR = 10 dB." },
  { term: "Pd", name: "Probabilidad de detección", definition: "Probabilidad de declarar un objetivo cuando está presente. Depende del detector, del umbral y del modelo estadístico; se interpreta junto a la probabilidad de falsa alarma.", equation: "Pd = P(declarar objetivo | objetivo presente)", example: "Detectar en 90 de 100 ensayos con objetivo da una estimación de 0,90." },
  { term: "CRLB", name: "Cramér-Rao Lower Bound", definition: "Cota inferior de la varianza de estimadores insesgados bajo condiciones de regularidad y un modelo estadístico especificado. No es el error medido de un algoritmo.", equation: "var(R̂) ≥ CRLBR   [m²]", example: "La raíz de una cota de 0,04 m² es 0,2 m, una cota de desviación estándar." },
        ...
        {matches.map(({ term, name, definition, equation, example }) => (
          <details key={term}>
            ...
            <div className="glossary-definition">
              <p>{definition}</p>
              {equation ? <p className="equation">{equation}</p> : null}
